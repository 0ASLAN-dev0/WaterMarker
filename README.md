...
**Step 1**: Download `WaterMarker.crx` from the [Releases](../../releases) page
...
The WaterMarker extension will appear in your extensions tab. Click it on any tab to get started.
...
2. Click the **WaterMarker** extension in your extensions tab
